...
*******************************************************************************/
unsigned int    SPI_Ethernet_readPacket();
...
unsigned int SPI_Ethernet_sendUDP2(unsigned char *destMAC, unsigned char *destIP, unsigned int sourcePort, unsigned int destPort, unsigned int pktLen);
...
unsigned int SPI_Ethernet_DHCPReceive(void);
unsigned int SPI_Ethernet_DHCPmsg(unsigned char  messageType, unsigned char renewFlag);
...
*******************************************************************************/
unsigned int SPI_Ethernet_TXpacket(unsigned int l);
...
*******************************************************************************/
unsigned int   SPI_Ethernet_memcmp(unsigned int addr, unsigned char *s, unsigned char l);
